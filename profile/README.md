...
erDiagram
	...
	Users }o--|| ActivityLogs : references
	Projects ||--|| Datasets : references
	Datasets }o--|| DataItems : references
	Datasets }o--|| Labels : references
	Projects }o--|| Assignments : references
	Users }o--|| Assignments : references
	Users }o--|| Assignments : references
	Users }o--|| Assignments : references
	Projects }o--|| Guidelines : references
	Assignments }o--|| Tasks : references
	Tasks }o--|| TaskItems : references
	DataItems }o--|| TaskItems : references
	Users ||--|| Reviews : references
	Tasks }o--|| Annotations : references
	DataItems ||--|| Annotations : references
	Users ||--|| Annotations : references
	Labels }o--|| AnnotationLabels : references
	Annotations }o--|| AnnotationLabels : references
	...
	ProjectMembers {
		VARCHAR(255) project_memeber_id
		VARCHAR(255) project_id
		VARCHAR(255) user_id
	}
	...
	Datasets {
		VARCHAR(255) dataset_id
		VARCHAR(255) project_id
		VARCHAR(255) dataset_name
		VARCHAR(255) description
		INTEGER total_items
		ENUM dataset_status
		DATETIME created_at
	...
	Labels {
		VARCHAR(255) label_id
		VARCHAR(255) dataset_id
		VARCHAR(255) label_name
		VARCHAR(255) color
		VARCHAR(255) description
		ENUM lable_status
		DATETIME created_at
	...
	Guidelines {
		VARCHAR(255) guidline_id
		VARCHAR(255) project_id
		VARCHAR(255) title
		VARCHAR(255) content
		VARCHAR(255) version
		ENUM guideline_status
		DATETIME created_at
		DATETIME updated_at
	}
	...
	Reviews {
		VARCHAR(255) review_id
		VARCHAR(255) annotation_id
		VARCHAR(255) reviewer_id
		ENUM review_status
		VARCHAR(255) evidence
		VARCHAR(255) comment
		VARCHAR(255) reviewed_at
	}
